        ...
        try {
            ...
            for (int i = 0; i < resultData.size(); ++i) {
                if (i == resultData.size() - 1) {
                    ...
                    statement.executeUpdate("INSERT INTO PredictionANN VALUES ('" + SYMBOLS[symbolNum] + "', '" + resultDate.get(i) + "', " + resultData.get(i) + "," + Math.round((resultData.get(i) - historicalData.get(i + trainingLength)) / historicalData.get(i + trainingLength) * 10000.0) / 100.0 + ", '"+ action +"')");
                }
            }
